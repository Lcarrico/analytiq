...
- Name: r15s1_router.spec.js >> deep link renders the artifacts screen directly
- Location: tests/ui/r15s1_router.spec.js:4:5
...
Locator: getByTestId('roi-report-btn')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('roi-report-btn')
