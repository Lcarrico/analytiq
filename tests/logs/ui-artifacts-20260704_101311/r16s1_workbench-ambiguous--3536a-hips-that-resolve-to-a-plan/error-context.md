...
- Name: r16s1_workbench.spec.js >> ambiguous prompt yields clarification chips that resolve to a plan
- Location: tests/ui/r16s1_workbench.spec.js:35:5
...
Locator: getByTestId('clarify-chips')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('clarify-chips')
...
- text: app / create / 22
- main:
  - text: How is net revenue trending lately Proposed plan Goal How is net revenue trending lately Metric Net Revenue Grain Location · Day Time range 2023-01-01 → 2023-12-31 Output kpi_summary Horizon — Access No PII restrictions apply to this plan
  - button "Approve & Build"
  - textbox "Ask a business question…"
  - button "⏎ Build"
  - text: approve the plan to start the build
```
