...
- Name: r21s1_tokens.spec.js >> P exposes every mockup frame color under its checklist §0.2 name
- Location: tests/ui/r21s1_tokens.spec.js:25:5

# Error details

```
Error: window.__TOKENS__ hook missing (main.jsx)
