...
- Name: r15s1_shell.spec.js >> navigating an unbuilt area shows its placeholder
- Location: tests/ui/r15s1_shell.spec.js:49:5
...
Call log:
  - waiting for getByTestId('app-sidebar').getByRole('link', { name: 'Team', exact: true })
