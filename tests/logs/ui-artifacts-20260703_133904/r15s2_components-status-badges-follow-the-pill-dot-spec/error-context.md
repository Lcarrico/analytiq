...
- main:
  ...
  - combobox:
    ...
    - option "Warn"
  - img
  - text: Badge Spec 935868 Predictive ⚕ 82 DQ pass MAPE 8.9% 👤 analyst@acme.com 🕐 Jul 3, 2026
  - button "Open"
  - button "☆"
  - button "Preview"
  - button "Insights"
  ...
  - button "✕"
  - img
  - text: BBB Sort 905005 Predictive ⚕ 82 DQ pass MAPE 8.9% 👤 analyst@acme.com 🕐 Jul 3, 2026
  - button "Open"
  - button "☆"
  - button "Preview"
  - button "Insights"
  ...
  - button "✕"
  - img
  - text: AAA Sort 905005 Predictive ⚕ 82 DQ pass MAPE 8.9% 👤 analyst@acme.com 🕐 Jul 3, 2026
  - button "Open"
  - button "☆"
  - button "Preview"
  - button "Insights"
